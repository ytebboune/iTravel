...
// Hash bcrypt pour le mot de passe 'azerty123'
...
async function main() {
  ...
  try {
    ...
    // Préparation des données des pays
    ...
    // Nettoyage complet (ordre des dépendances)
    ...
    // Posts, photos, likes, commentaires
    ...
    // Projet de voyage ultra-complet
    ...
    // Votes, commentaires, likes sur activités/destinations/transport/accommodation
    ...
    // PrédefinedActivity, PlanningActivity, Planning
